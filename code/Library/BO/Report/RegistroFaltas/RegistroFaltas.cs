...
namespace moleQule.Library.Instruction
{
	...
	/// </summary>
    [Serializable()]
	public class RegistroFaltas : BusinessBaseEx<RegistroFaltas>
	{
        ...
        public virtual long TotalModulo
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                CanReadProperty(true);
                return _total_modulo;
            }
        ...
        public virtual long TotalSubmodulo
        {
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
            get
            {
                CanReadProperty(true);
                return _total_submodulo;
            }
            ...
            set
            {
                ...
                if (!_total_submodulo.Equals(value))
                {
                    _total_submodulo = value;
                    PropertyHasChanged();
                }
            }
        }
        ...
        public virtual DateTime FechaRecuperacion
        {
            ...
            set
            {
                ...
                if (!_fecha_recuperacion.Equals(value))
                {
                    _fecha_recuperacion = value;
                    PropertyHasChanged();
                }
            }
        }
		...
		public virtual RegistroFaltas CloneAsNew()
		{
			RegistroFaltas clon = base.Clone();
			
			//Se definen el Oid y el Coidgo como nueva entidad
			Random rd = new Random();
			clon.Oid = rd.Next();
			clon.SessionCode = RegistroFaltas.OpenSession();
			RegistroFaltas.BeginTransaction(clon.SessionCode);
		...
		public static RegistroFaltas New()
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException(
				  moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);
			
			return DataPortal.Create<RegistroFaltas>(new CriteriaCs(-1));
		}
			
		public static RegistroFaltas Get(long oid)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException(
				  moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);
			...
			RegistroFaltas.BeginTransaction(criteria.Session);
			
			return DataPortal.Fetch<RegistroFaltas>(criteria);
		}
		
		internal static RegistroFaltas Get(IDataReader reader)
		{
			return new RegistroFaltas(reader, true);
		}
		...
		public static void DeleteAll()
		{
			...
			int sessCode = RegistroFaltas.OpenSession();
			ISession sess = RegistroFaltas.Session(sessCode);
			ITransaction trans = RegistroFaltas.BeginTransaction(sessCode);
			
			try
			{	
				sess.Delete("from RegistroFaltas");
				trans.Commit();
			}
			catch (Exception ex)
			{
			...
			{
				RegistroFaltas.CloseSession(sessCode);
			}
		}
		
		public override RegistroFaltas Save()
		{
		...
		/// </summary>
        private RegistroFaltas(RegistroFaltas source, bool retrieve_childs)
        {
			MarkAsChild();
		...
		/// NO UTILIZAR DIRECTAMENTE. LAS UTILIZAN LAS FUNCIONES DE CREACION DE LISTAS
		/// </summary>
        private RegistroFaltas(IDataReader source, bool retrieve_childs)
        {
            MarkAsChild();	
			Childs = retrieve_childs;
            Fetch(source);
        ...
        public static RegistroFaltas NewChild() 
		{
			if (!CanAddObject())
				throw new System.Security.SecurityException(
				  moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);
		...
		/// <remarks/>
        internal static RegistroFaltas GetChild(RegistroFaltas source)
		{
            return new RegistroFaltas(source, false);
		}
        ...
        internal static RegistroFaltas GetChild(RegistroFaltas source, bool retrieve_childs)
		{
            return new RegistroFaltas(source, retrieve_childs);
		}
		...
		/// <remarks/>
        internal static RegistroFaltas GetChild(IDataReader source)
        {
            return new RegistroFaltas(source, false);
        }
		...
		/// <returns>Objeto creado</returns>
		/// <remarks>La utiliza la BusinessListBaseEx correspondiente para montar la lista<remarks/>
        internal static RegistroFaltas GetChild(IDataReader source, bool retrieve_childs)
        {
            return new RegistroFaltas(source, retrieve_childs);
        }
        ...
        public virtual RegistroFaltasInfo GetInfo()
		{
			return GetInfo(true);
		}
		...
		/// <returns>Réplica de solo lectura del objeto</returns>
        public virtual RegistroFaltasInfo GetInfo(bool get_childs)
		{
			if (!CanGetObject())
				throw new System.Security.SecurityException(
				  moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);

            return new RegistroFaltasInfo(this, get_childs);
		}
        ...
        private void Fetch(RegistroFaltas source)
        {
            try
            {
		...
		protected override void DataPortal_Update()
		{
			if (IsDirty)
			{
				try
				{
                    RegistroFaltas obj = Session().Get<RegistroFaltas>(Oid);
					obj.CopyValues(this);
					Session().Update(obj);
				}
				catch (Exception ex)
