...
{
    public partial class InstructorMngForm : moleQule.Face.Skin02.EntityLMngSkinForm
    {
        ...
        internal new InstructorList List
        {
            ...
            set { _item_list = value; _sorted_list = (value as InstructorList).GetSortedList(); }
        }
		...
		public override void DeleteObject(long oid)
		{
								...
								MessageBoxIcon.Question) == DialogResult.Yes)
			{
				...
				{
                    //Se elimina la foto
                    Images.Delete(List.GetItem(oid).Foto, Controler.FOTOS_INSTRUCTORES_PATH);
        ...
        protected new SortedBindingList<InstructorInfo> Localize(object value, string column_name)
        {
