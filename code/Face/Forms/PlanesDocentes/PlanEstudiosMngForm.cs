...
{
    public partial class PlanEstudiosMngForm : PlanEstudiosMngBaseForm
    {
        ...
        public PlanEstudiosMngForm() : this(false, null) { }

        public PlanEstudiosMngForm(Form parent) : this(false, parent) { }

        public PlanEstudiosMngForm(bool isModal, Form parent) : this(isModal, parent, null) { }
        ...
        protected override void RefreshMainData()
        {
            ...
            PgMng.Grow(string.Empty, "Lista de PlanEstudioss");
        }
    ...
    public partial class PlanEstudiosMngBaseForm : Skin06.EntityMngSkinForm<PlanEstudiosList, PlanEstudiosInfo>
    {
        public PlanEstudiosMngBaseForm()
            : this(false, null, null) { }

        public PlanEstudiosMngBaseForm(bool isModal, Form parent, PlanEstudiosList lista)
