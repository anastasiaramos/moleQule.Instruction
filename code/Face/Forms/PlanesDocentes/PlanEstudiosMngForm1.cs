...
{
    public partial class PlanEstudiosMngForm : Skin02.EntityLMngSkinForm
    {

        #region Attributes & Properties
		
        public const string ID = "PlanEstudiosMngForm";
        public static Type Type { get { return typeof(PlanEstudiosMngForm); } }
        public override Type EntityType { get { return typeof(PlanEstudios); } }

		protected override int BarSteps { get { return base.BarSteps + 4; } }

        protected PlanEstudios _entity;

        private new SortedBindingList<PlanEstudiosInfo> _filter_results = null;
        private new SortedBindingList<PlanEstudiosInfo> _sorted_list = null;
        private new SortedBindingList<PlanEstudiosInfo> _search_results = null;

        /// <summary>
        ///  Lista de objetos de sólo lectura
        /// </summary>
        internal new PlanEstudiosList List
        {
            get { return _item_list as PlanEstudiosList; }
            set { _item_list = value; _sorted_list = (value as PlanEstudiosList).GetSortedList(); }
        }
        internal new SortedBindingList<PlanEstudiosInfo> SortedList { get { return _sorted_list; } }
        internal new PlanEstudiosList FilteredList { get { return PlanEstudiosList.GetList(_filter_results); } }
        internal SortedBindingList<PlanEstudiosInfo> CurrentList { get { return (Datos.List as SortedBindingList<PlanEstudiosInfo>); } } 

		/// <summary>
		/// Devuelve el OID del objeto activo seleccionado de la tabla
		/// </summary>
		/// <returns></returns>
		public override long ActiveOID { get { return Datos.Current != null ? ((PlanEstudiosInfo)Datos.Current).Oid : -1; } }

        /// <summary>
        /// Devuelve el objeto activo seleccionado de la tabla
        /// </summary>
        /// <returns></returns>
        public PlanEstudiosInfo ActiveItem { get { return (Datos.Current != null) ? (PlanEstudiosInfo)Datos.Current : null; } }
		
        public override long ActiveFoundOID { get { return (DatosSearch.Current != null) ? ((PlanEstudiosInfo)(DatosSearch.Current)).Oid : -1; } }
		...
		public PlanEstudiosMngForm()
            : this(false) {}

		public PlanEstudiosMngForm(bool isModal)
            : this(isModal, null) { }

        public PlanEstudiosMngForm(Form parent)
            : this(false, parent) { }
		
		public PlanEstudiosMngForm(bool isModal, Form Parent)
			: base(isModal, Parent)
		{
			InitializeComponent();
        ...
        protected void SetMainList(SortedBindingList<PlanEstudiosInfo> list, bool order)
        {
        ...
        public override void OpenAddForm()
        {
            try
            {
                PlanDocenteAddForm form = new PlanDocenteAddForm();
                AddForm(form);
                _entity = form.Entity;
            }
		...
		public override void OpenViewForm()
		{
			...
			try
			{
				AddForm(new PlanDocenteViewForm(ActiveOID));
			}
			catch (Csla.DataPortalException ex)
			{
				MessageBox.Show(ex.BusinessException.ToString(),
		...
		{
			/*PlanEstudiosReportMng reportMng = new PlanEstudiosReportMng(AppContext.ActiveSchema);
			
			PlanEstudiosListRpt report = reportMng.GetListReport(list);
