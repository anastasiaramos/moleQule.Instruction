...
{
    public partial class PracticasActionForm : ActionSkinForm
    {
        ...
        public const string ID = "PracticasActionForm";
        public static Type Type { get { return typeof(PracticasActionForm); } }
        ...
        public PracticasActionForm()
            : this(true) { }

        public PracticasActionForm(bool IsModal)
            : base(IsModal)
        {
            InitializeComponent();
            SetFormData();
            this.Text = Resources.Labels.PRACTICAS_TITLE;
        }
