...
{
    public partial class CursoMngForm : CursoMngBaseForm
    {
        ...
        public CursoMngForm() : this(false, null) { }

        public CursoMngForm(Form parent) : this(false, parent) { }

        public CursoMngForm(bool isModal, Form parent) : this(isModal, parent, null) { }

        public CursoMngForm(bool isModal, Form parent, CursoList list)
            : base(isModal, parent, list)
        {
            ...
            Datos.DataSource = CursoList.NewList().GetSortedList();
            base.SortProperty = Observaciones.DataPropertyName;

            this.Text = Resources.Labels.CURSOS;
        }
        ...
        protected override void RefreshMainData()
        {
            ...
            PgMng.Grow(string.Empty, "Lista de Cursos");
        }
        ...
        protected new SortedBindingList<CursoInfo> Localize(FilterItem item)
        {
    ...
    public partial class CursoMngBaseForm : Skin06.EntityMngSkinForm<CursoList, CursoInfo>
    {
        public CursoMngBaseForm()
            : this(false, null, null) { }

        public CursoMngBaseForm(bool isModal, Form parent, CursoList lista)
