...
{
    public partial class CronogramaMngForm : CronogramaMngBaseForm
    {
            ...
            : base(isModal, parent, list)
        {
            ...
            Datos.DataSource = CronogramaList.NewList().GetSortedList();

            SetMainDataGridView(Tabla);
            base.SortProperty = Promocion.DataPropertyName;
        ...
        public override void FormatControls()
        {
            ...
            Fields_CB.Text = Promocion.HeaderText;

            SetColumnActive(ControlsMng.GetColumn(Tabla, FechaCreacion.DataPropertyName));
        ...
        {
            PgMng.Grow(string.Empty, "Cronograma");
        ...
        public override void PrintList()
        {
            ...
            CronogramaListRpt report = reportMng.GetListReport(list);
    ...
    public partial class CronogramaMngBaseForm : Skin06.EntityMngSkinForm<CronogramaList, CronogramaInfo>
    {
        public CronogramaMngBaseForm()
            : this(false, null, null) { }

        public CronogramaMngBaseForm(bool isModal, Form parent, CronogramaList lista)
