...
{
    public partial class MaterialMngForm : Skin02.EntityLMngSkinForm
    {
        ...
        private new SortedBindingList<MaterialDocenteInfo> _filter_results = null;
        private new SortedBindingList<MaterialDocenteInfo> _sorted_list = null;
        private new SortedBindingList<MaterialDocenteInfo> _search_results = null;

        /// <summary>
        ///  Lista de objetos de sólo lectura
        /// </summary>
        internal new MaterialDocenteList List
        {
            get { return _item_list as MaterialDocenteList; }
            set { _item_list = value; _sorted_list = (value as MaterialDocenteList).GetSortedList(); }
        }
        internal new SortedBindingList<MaterialDocenteInfo> SortedList { get { return _sorted_list; } }
        internal new MaterialDocenteList FilteredList { get { return MaterialDocenteList.GetList(_filter_results); } }
        internal SortedBindingList<MaterialDocenteInfo> CurrentList { get { return (Datos.List as SortedBindingList<MaterialDocenteInfo>); } } 

		/// <summary>
		/// Devuelve el OID del objeto activo seleccionado de la tabla
		/// </summary>
		/// <returns></returns>
		public override long ActiveOID { get { return Datos.Current != null ? ((MaterialDocenteInfo)Datos.Current).Oid : -1; } }

        /// <summary>
        /// Devuelve el objeto activo seleccionado de la tabla
        /// </summary>
        /// <returns></returns>
        public MaterialDocenteInfo ActiveItem { get { return (Datos.Current != null) ? (MaterialDocenteInfo)Datos.Current : null; } }
		
        public override long ActiveFoundOID { get { return (DatosSearch.Current != null) ? ((MaterialDocenteInfo)(DatosSearch.Current)).Oid : -1; } }
		...
		public MaterialMngForm()
            : this(false) {}

		public MaterialMngForm(bool isModal)
			: this(isModal, null) {}

        public MaterialMngForm(Form Parent)
            : base(false, Parent) { }
		
		public MaterialMngForm(bool isModal, Form Parent)
			: base(isModal, Parent)
		{
			InitializeComponent();
		...
		{
			/*MaterialDocenteReportMng reportMng = new MaterialDocenteReportMng(AppContext.ActiveSchema);
        ...
        protected new SortedBindingList<MaterialDocenteInfo> Localize(object value, string column_name)
        {
