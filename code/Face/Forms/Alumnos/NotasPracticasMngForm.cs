...
{
    public partial class NotasPracticasMngForm : NotasPracticasMngBaseForm
    {
        #region Attributes & Properties

        public const string ID = "NotasPracticasMngForm";
        public static Type Type { get { return typeof(NotasPracticasMngForm); } }
        public override Type EntityType { get { return typeof(NotaPracticas); } }

        protected override int BarSteps { get { return base.BarSteps + 3; } }

        protected NotaPracticas _entity;
        protected long _oid_promocion = 0;

        #endregion

        #region Factory Methods

        public NotasPracticasMngForm() : this(0, false, null) { }

        public NotasPracticasMngForm(long oid_promo, Form parent) : this(oid_promo, false, parent) { }
        ...
        protected void SetMainList(SortedBindingList<NotaPracticasInfo> list, bool order)
        {
    ...
    public partial class NotasPracticasMngBaseForm : Skin06.EntityMngSkinForm<NotaPracticasList, NotaPracticasInfo>
    {
        public NotasPracticasMngBaseForm()
            : this(false, null, null) { }

        public NotasPracticasMngBaseForm(bool isModal, Form parent, NotaPracticasList lista)
