...
{
    public partial class RegistroFaltasAlumnosMngForm : RegistroFaltasAlumnosMngBaseForm
    {
        #region Attributes & Properties

        public const string ID = "RegistroFaltasAlumnosMngForm";
        public static Type Type { get { return typeof(RegistroFaltasAlumnosMngForm); } }
        public override Type EntityType { get { return typeof(RegistroFaltas); } }
        ...
        public RegistroFaltasAlumnosMngForm() : this(false, null) { }

        public RegistroFaltasAlumnosMngForm(Form parent) : this(false, parent) { }

        public RegistroFaltasAlumnosMngForm(bool isModal, Form parent)
            : base(isModal, parent, null)
        {
            ...
            Datos.DataSource = RegistroFaltasList.NewList().GetSortedList();
        ...
        protected void SetMainList(SortedBindingList<RegistroFaltasInfo> list, bool order)
        {
        ...
        protected override void RefreshMainData()
        {
            ...
            switch (DataType)
            {
                case EntityMngFormTypeData.Default:
                    List = RegistroFaltasList.GetList();
                    break;
        ...
        protected new SortedBindingList<RegistroFaltasInfo> Localize(FilterItem item)
        {
            SortedBindingList<RegistroFaltasInfo> list = null;
            RegistroFaltasList sourceList = null;
    ...
    public partial class RegistroFaltasAlumnosMngBaseForm : Skin06.EntityMngSkinForm<RegistroFaltasList, RegistroFaltasInfo>
    {
        public RegistroFaltasAlumnosMngBaseForm()
            : this(false, null, null) { }

        public RegistroFaltasAlumnosMngBaseForm(bool isModal, Form parent, RegistroFaltasList lista)
