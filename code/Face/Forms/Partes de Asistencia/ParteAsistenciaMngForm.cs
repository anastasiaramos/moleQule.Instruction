...
{
    public partial class ParteAsistenciaMngForm : ParteAsistenciaMngBaseForm
    {

        #region Attributes & Properties

        public const string ID = "ParteAsistenciaMngForm";
        public static Type Type { get { return typeof(ParteAsistenciaMngForm); } }
        ...
        public DataGridViewCellStyle ConfirmadaStyle = new DataGridViewCellStyle();

        #endregion

        #region Factory Methods

        public ParteAsistenciaMngForm()
            : this(false) { }

        public ParteAsistenciaMngForm(bool isModal)
            : this(isModal, null) { }

        public ParteAsistenciaMngForm(Form parent)
            : this(false, parent) { }

        public ParteAsistenciaMngForm(bool isModal, Form parent)
        ...
        protected override void SetRowFormat(DataGridViewRow row)
        {
            ...
            ParteAsistenciaInfo item = (ParteAsistenciaInfo)row.DataBoundItem;

            if (item.Confirmada)
                row.DefaultCellStyle = ConfirmadaStyle;
        }
        ...
        public override void OpenViewForm()
        {
            try
            {
                AddForm(new PAsistenciaViewForm(ActiveOID));
            }
            catch (Csla.DataPortalException ex)
            {
                MessageBox.Show(ex.BusinessException.ToString(),
    ...
    public partial class ParteAsistenciaMngBaseForm : Skin06.EntityMngSkinForm<ParteAsistenciaList, ParteAsistenciaInfo>
    {
        public ParteAsistenciaMngBaseForm()
            : this(false, null, null) { }

        public ParteAsistenciaMngBaseForm(bool isModal, Form parent, ParteAsistenciaList lista)
